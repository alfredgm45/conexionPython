...
def insercionPuntosSiog(nombrePlanta,servidor):
	...
	buscador.buscarDatosGalba(servidor)

	entradaPuntos = lectorEntradaPunto.retornarArregloJsonPtyhon(nombrePlanta)
	...
	if validacionEntradaPuntos(entradaPuntos["point_id"],entradaPuntos["id_proceso"])==1:
		...
		if len(coordenadasD)>0:
			calidadesD = html.retornarCalidadPuntoDigital(nombrePlanta,points,coordenadasD)
			estadosD = html.retornarEstadoPuntoDigital(nombrePlanta,points, coordenadasD)
		else:
		...
		if len(coordenadasA)>0:
			calidadesA=html.retornarCalidadPuntoAnalogico(nombrePlanta,points,coordenadasA)
			valoresA = html.retornarValorPuntoAnalogico(nombrePlanta, points , coordenadasA)
		else:
